...
import com.askj.crm.commons.domain.ReturnObject;
import com.askj.crm.commons.utils.DateUtils;
import com.askj.crm.commons.utils.UUIDUtils;
import com.askj.crm.settings.domain.User;
import com.askj.crm.workbench.domain.ActivityRemark;
import com.askj.crm.workbench.service.ActivityRemarkService;
...
public class ActivityRemarkController {
    ...
    public Object saveCreateActivityRemark(ActivityRemark activityRemark, HttpSession session) {
        ...
        try {
            ...
            if (res > 0) { // 插入成功
                ...
                returnObject.setRetData(activityRemark); // 将备注也传到前端响应到页面
    ...
    public Object saveEditActivityRemark(ActivityRemark activityRemark, HttpSession session) {
        User user = (User) session.getAttribute(Contants.SESSION_USER); // 获取当前的user对象
        // 封装参数
